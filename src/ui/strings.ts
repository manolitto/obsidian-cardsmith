...
const en = {
  ...
  "settings.open-in.name": "Open preview and PDF in",
  "settings.open-in.desc":
    "Where the deck preview and an exported PDF open, relative to the note.",
  "settings.open-in.tab": "New tab",
  "settings.open-in.split-right": "Split right",
  "settings.open-in.split-down": "Split down",
  "settings.open-in.window": "New window",
...
const de: Strings = {
  ...
  "settings.open-in.name": "Vorschau und PDF öffnen in",
  "settings.open-in.desc":
    "Wo die Deck-Vorschau und ein exportiertes PDF geöffnet werden, relativ zur Notiz.",
  "settings.open-in.tab": "Neuer Tab",
  "settings.open-in.split-right": "Geteilt rechts",
  "settings.open-in.split-down": "Geteilt unten",
  "settings.open-in.window": "Neues Fenster",
